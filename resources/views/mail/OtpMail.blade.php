                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{ $logo }}" width="" height="59" border="0" alt="" /></td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    {{-- <tr>
                                                        <td class="h2 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:35px; line-height:60px; text-align:center; padding-bottom:10px;">Your OTP is {{ $otp }} valid for 10 minutes. Thanks for registering with us.Install SimplySellBooks app to get upto 50% back! UsedBookR</td>
                                                    </tr> --}}
                                                    <tr>
