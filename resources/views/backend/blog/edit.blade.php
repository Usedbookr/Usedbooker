    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('blog.store') }}" id="myForm" enctype="multipart/form-data">
                ...
                <input type="hidden" name="blog_id" value="{{ $ratingreview->id }}">
                <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-9">
                                <select class="form-select" aria-label="Default select example" name="author_id">
                                    ...
                                    @foreach($blog_author as $key => $author)
                                        <option value="{{ $author->id }}" @if($ratingreview->author_id == $author->id) selected @endif>{{ $author->name }}</option>
                                    @endforeach
                                    @endif
                            ...
                            <div class="form-group col-sm-9">
                                <select class="form-select" aria-label="Default select example" name="category_id">
                                    ...
                                    @foreach($blog_category as $key => $category)
                                        <option value="{{ $category->id }}" @if($ratingreview->category_id == $category->id) selected @endif>{{ $category->name }}</option>
                                    @endforeach
                                    @endif
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-9">
                                <input name="name" class="form-control" type="text" id="cat_id_name"  onkeyup="CatogeryUrl()"  value="{{ $ratingreview->name }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-9">
                                <input name="author_slug" class="form-control" type="text" id="url_slug" value="{{ $ratingreview->slug }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            @if($ratingreview->slug)
                                <img src="{{ url('/') }}/public/upload/admin_images/blog/{{ $ratingreview->blog_image }}" alt="" style="width: 100px;">
                                <input type="hidden" name="old_blog_image" value="{{ $ratingreview->blog_image }}">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-md-12" style="margin-bottom: 10px;">
                        ...
                        <textarea name="description" id="summernote" class="form-control" cols="200" rows="20">{{ $ratingreview->description }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-9">
                                <input name="meta_name" class="form-control" type="text" id="meta_name_id" value="{{ $ratingreview->meta_title }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-9">
                                <input name="meta_description" class="form-control" type="text" value="{{ $ratingreview->meta_description }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-9">
                                <input name="meta_keyword" class="form-control" type="text" value="{{ $ratingreview->meta_keyword }}">
                            </div>
                        </div>
                    </div>
