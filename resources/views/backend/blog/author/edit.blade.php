...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Edit Blog Author </h4><br><br>
            ...
            <form method="post" action="{{ route('blog.author.store') }}" id="myForm" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-3 col-form-label"> Author Slug </label>
                                <div class="form-group col-sm-9">
                                    <input name="author_slug" class="form-control" type="text"  value="{{ $ratingreview->author_slug }}"  id="url_slug" required>
                                </div>
                            </div>
                        </div>
