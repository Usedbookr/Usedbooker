...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Edit Blog Comment </h4><br><br>
            
  
            <form method="post" action="{{ route('blog.comment.edit.store') }}" id="myForm" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9">
                                    <input name="name" class="form-control" type="text" id="cat_id_name" value="{{ $ratingreview->name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9">
                                    <input name="email" class="form-control" type="text" id="cat_id_name" value="{{ $ratingreview->email }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9">
                                    <input name="phone" class="form-control" type="text" id="cat_id_name" value="{{ $ratingreview->phone }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9">
                                    <input name="comments" class="form-control" type="text" id="cat_id_name" value="{{ $ratingreview->comments }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9">
                                    <select class="form-select" aria-label="Default select example" name="status">
                                        <option value="Pending" @if($ratingreview->status == "Pending") selected @endif>Pending</option>
                                        <option value="Approve" @if($ratingreview->status == "Approve") selected @endif>Approve</option>
                                        <option value="Reject" @if($ratingreview->status == "Reject") selected @endif>Reject</option>
                                      </select>
                                </div>
                            </div>
                        </div>
