                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> {{ $item->name }} </td>
                                    <td>
                                        <img src="{{ url('/') }}/public/upload/admin_images/blog/{{ $item->blog_image }}" alt="" style="width: 100px;">
                                    </td>
                                    <td> {{ $item->status }} </td>
                                    <td>
                                        <a href="{{ route('blog.edit',$item->id) }}" class="btn btn-info sm" title="Edit Data">  <i class="fas fa-edit"></i> </a>

                                        <a href="{{ route('blog.delete',$item->id) }}" data-confirm="Are you delete this Category?" class="delete btn btn-danger sm" title="Delete Data" id="delete">  <i class="fas fa-trash-alt"></i> </a>
