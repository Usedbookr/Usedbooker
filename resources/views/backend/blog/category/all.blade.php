        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <a href="{{route('blog.category.add')}}" class="btn btn-info">Add Blog Category</a>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('blog.category.delete',$item->id) }}" data-confirm="Are you delete this Category?" class="delete btn btn-danger sm" title="Delete Data" id="delete">  <i class="fas fa-trash-alt"></i> </a>
