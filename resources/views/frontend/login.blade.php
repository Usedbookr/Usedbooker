            ...
            <div class="col-lg-4 col-xxl-4 offset-lg-1 col-md-7">
               <div class="login-detail">
                  ...
                  <h5 class="login-title">Login with OTP</h5>
                    <p class="login-text">First time shopping with us?<br><a href="{{ route('user.register') }}"><u style="font-size: 13px;">Register here to create a new account!</u></a></p>
                  <form method="POST" action="{{ route('otp.login.user') }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <button type="submit" class="btn yellow-btn shadow-btn d-block w-100">Get OTP</button>
                      </div>
                  </form>
                </div>
            </div>
