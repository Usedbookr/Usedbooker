            ...
            <div class="col-lg-4 col-xxl-3 offset-lg-1 col-md-7">
               <div class="login-detail">
                  ...
                  <form action="{{ route('otp.verify') }}" method="POST">
                    @csrf
                    <input type="hidden" name="user_id_otp_check" id="user_id_otp_check" value="{{ $user_details->id }}">
                    ...
                    <div class="form-group">
                        <span id="timer"></span>
                        <a id="resendOtpLink" onclick="resendOtp('{{ $user_details->id }}')" data-user-id="{{ $user_details->id ?? '' }}" style="cursor: pointer;">Resend OTP</a>
                    </div>
